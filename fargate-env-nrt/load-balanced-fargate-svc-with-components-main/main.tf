...
To manage this resource, see AWS Proton Resource: arn:aws:proton:ap-northeast-1:259837135622:service/load-balanced-fargate-svc-with-components/service-instance/main
