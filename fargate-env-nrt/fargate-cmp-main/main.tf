...
To manage this resource, see AWS Proton Resource: arn:aws:proton:ap-northeast-1:259837135622:service/fargate-cmp/service-instance/main
...
resource "aws_security_group" "lb_sg" {
  ...
  name_prefix = "service_lb_security_group"
...
resource "aws_lb" "service_lb" {
  name_prefix        = "${var.service.name}-lb"
...
resource "aws_security_group" "service_security_group" {
  name_prefix = "service_security_group"
